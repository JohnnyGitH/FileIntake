...
public static class DbInitializer
{
    public static async Task Initialize(ApplicationDbContext context, IServiceProvider serviceProvider)
    {
        ...
        // var johnny = await userManager.FindByEmailAsync("johnny@example.com");
        // if (johnny != null)
        // {
        //     await userManager.RemovePasswordAsync(johnny);
        //     await userManager.AddPasswordAsync(johnny, "Password123!");
        //     Console.WriteLine("Johnny password reset inside Docker!");
        // }
